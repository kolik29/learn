...
(function ($) {
    ...
    $.cleditor = {
        ...
        defaultOptions: {
            ...
            height: 'calc(100% - 10px)', // height not including margins, borders or padding
            ...
            styles:       // styles in the style popup
                          [["Параграф", "<p>"], ["Заголовок 1", "<h1>"], ["Заголовок 2", "<h2>"],
        ...
        buttons: {
            ...
            "font,Шрифт,fontname,|" +
            "size,Размер шрифта,fontsize,|" +
            "style,Стиль,formatblock,|" +
            "color,Цвета шрифта,forecolor,|" +
            "highlight,Цвет выделения,hilitecolor,color|" +
            "removeformat,Удалить форматирование,|" +
            "bullets,Маркированный,insertunorderedlist|" +
            "numbering,Нумерованный,insertorderedlist|" +
            "outdent,Отступ,|" +
            "indent,Выступ,|" +
            "alignleft,Выравнивание слева,justifyleft|" +
            "center,Выравнивание по центру,justifycenter|" +
            "alignright,Выравнивание справа,justifyright|" +
            "justify,Выравнивание по ширине,justifyfull|" +
            "undo,Назад,|" +
            "redo,Вперед,|" +
            "rule,Горизонтальная линия,inserthorizontalrule|" +
            "image,Вставить картинку,insertimage,url|" +
            "link,Вставить ссылку,createlink,url|" +
            "unlink,Удалить ссылку,|" +
            "cut,Вырезать,|" +
            "copy,Копировать,|" +
            "paste,Вставить,|" +
            "pastetext,Вставить как текст,inserthtml,|" +
            "print,Печать,|" +
            "source,Показать код"
        },
    ...
    function createPopup(popupName, options, popupTypeClass, popupContent, popupHover) {
        ...
        // Paste as Text
            ...
            $popup.html('<label>Вставьте текст:<br /><textarea rows="3" style="width:200px"></textarea></label><br /><input type="button" value="Готово" />');
            popupTypeClass = PROMPT_CLASS;
        }
